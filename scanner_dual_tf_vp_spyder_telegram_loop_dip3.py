...
# --------------------------- Scanner Config --------------------------- #
RAW_TICKERS = ["nvda","amd","orcl","avgo","pltr","net","amzn","google","msft","klac","ibm","tem","aapl","tqqq","bulz","cost","tsla","meta","now","nflx","hims","ntra","ddog","tsm","mu","crm","tsm","pltr","hims","ibm","rklb","crwd"]
