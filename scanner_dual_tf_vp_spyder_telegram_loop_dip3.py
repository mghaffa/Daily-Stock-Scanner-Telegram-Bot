...
# --------------------------- Scanner Config --------------------------- #
RAW_TICKERS = ["nvda","amd","orcl","avgo","pltr","net","amzn","googl","msft","klac","ibm","aapl","tqqq","intc","bulz","cost","tsla","meta","now","nflx","hims","ntra","ddog","tsm","mu","crm","tem","rklb","crwd","uvxy","intc","unh","jpm","abt","bynd","race", "gld", "gldm"]
