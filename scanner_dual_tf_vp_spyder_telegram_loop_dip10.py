...
# Universe
RAW_TICKERS = ["AAPL","AAPU","ABT","AGQ","AMD","AMZN","AMZU","ARKQ","ARKX","ARQQ","ASTS","ASTX","AVGO","AVGU","BULZ","BYND","CCJ","CEG","COST","COTG","CRM","CRWD","DDOG","DELL","DOGD","GLD","GLDM","GOOGL","HIMS",
    "HOLO","HOOD","HOOW","IBM","INTC","IONQ","JPM","KLAC","LAES","LLY","LMT","META","MSCI","MSFT","MU","MUU","NET","NEE","NFLX","NFXL","NOW","NOWL","NTRA","NVDA","OKLL","OKLO","ORCL","ORCX","PLTR","PLTU","QBTS",
    "QTUM","QUBT","RACE","RGTI","RKLB","RKLX","ROK","SCHD","SCHX","SHOP","SHNY","SLR","SMCI","SOFI","SOFI","TEM","TER","TQQQ","TSLA","TSLL","TSM","UNH","UPST","UVXY","VOO","VST","XEL","ZBRA"]
...
LRC_TOUCH_REPORT_DEDUP = _env_bool("LRC_TOUCH_REPORT_DEDUP", False)  # deduplicate LRC-touch notifications
